...
function Header() {
  ...
  const navList = (
    <ul className="mb-4 mt-2 flex flex-col gap-2 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6">
      ...
      >
        <a
          href="#"
          className="flex items-center text-[16px] font-[600] text-[#fff]"
        >
          Product
        </a>
      </Typography>
      ...
      <Button
        variant="gradient"
        size="sm"
        className="hidden   text-[16px] font-[700] lg:inline-block md:flex justify-center items-center w-[128px] h-[40px] rounded-[24px] text-[#0A2640]  bg-[#FFF]"
      >
        Login in
      </Button>
    </ul>
  ...
  return (
    <Navbar className="mx-auto border-none  py-2 px-4 lg:px-8 lg:py-4 bg-[#0A2640] items-center">
      <div className="container mx-auto flex items-center justify-between ">
        <Typography
          as="a"
          href="#"
          variant="small"
          className="mr-4 cursor-pointer py-1.5 font-normal text-[#fff]"
        >
          <svg
            width="163"
            height="42"
        ...
        <IconButton
          variant="text"
          className="ml-auto text-[#fff] h-6 w-6 text-inherit hover:bg-transparent focus:bg-transparent active:bg-transparent lg:hidden"
          ripple={false}
      ...
      <MobileNav open={openNav}>
        <div className="container mx-auto">
          ...
          <Button
            ...
            size="sm"
            fullWidth
            className="mb-2  text-[16px] font-[700] lg:inline-block  justify-center items-center w-[128px] h-[40px] rounded-[24px] text-[#0A2640]  bg-[#FFF]"
          >
            Login in
          </Button>
        </div>
